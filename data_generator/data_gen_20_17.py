        ...
        for k in range(N-1):
            ...
            if noised:
                ...
                radar_data.append([theta + np.random.randn() * Deg2Rad,
                                   ...
                                   r + 0.01 * r * np.random.randn(),
                                   vc + 0.001 * r * np.random.randn(),
                                   Pt_NED[0] + np.random.randn(),
                                   Pt_NED[1] + np.random.randn(),
                                   Pt_NED[2] + np.random.randn(),
                                   Pm_NED[0] + np.random.randn(),
                                   Pm_NED[1] + np.random.randn(),
                                   Pm_NED[2] + np.random.randn(),
                                   Vt_NED[0] + 2 * np.random.randn(),
                                   Vt_NED[1] + 2 * np.random.randn(),
                                   Vt_NED[2] + 2 * np.random.randn(),
                                   Vm_NED[0] + 2 * np.random.randn(),
                                   Vm_NED[1] + 2 * np.random.randn(),
                                   Vm_NED[2] + 2 * np.random.randn()])
            else:
                # save radar data with noise
                radar_data.append([theta, elev,
                                   azim, r, vc, *Pt_NED, *Pm_NED, *Vt_NED, *Vm_NED])
